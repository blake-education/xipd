(function() {
  var IPAddressSubdomain, MappedSubdomain, Server, Subdomain, dnsserver,
  ...
  exports.Server = Server = (function(_super) {
    var NS_C_IN, NS_RCODE_NXDOMAIN, NS_T_A, NS_T_CNAME, NS_T_NS, NS_T_SOA, createSOA, isARequest, isNSRequest, nameToEnum;
    ...
    Server.prototype.handleRequest = function(req, res) {
      var question, responseType, subdomain;
  ...
  exports.Subdomain = Subdomain = (function() {
    ...
    Subdomain.prototype.getResponseType = function() {
      return "A";
    };
  ...
  exports.MappedSubdomain = MappedSubdomain = (function(_super) {

    __extends(MappedSubdomain, _super);

    function MappedSubdomain() {
      MappedSubdomain.__super__.constructor.apply(this, arguments);
    }

    MappedSubdomain.pattern = /(^|\.).*$/;

    MappedSubdomain.prototype.getAddress = function() {
      var cname, lastLabel;
      lastLabel = this.labels.slice(-1)[0];
      cname = MappedSubdomain.db[lastLabel];
      console.log("getAddress", this.labels, cname, lastLabel);
      return cname;
    };

    MappedSubdomain.prototype.getResponseType = function() {
      return "CNAME";
    };
